...
public class App {
    ...
    public static String SiteMapLabel = "This is a map of the site (read from file: %1$s):";
    ...
    public void run() throws Exception {
        println(AppHeadingLabel);
        println(String.format(SiteMapLabel, getFileName()));
        ...
        println(InitialBulldozerPositionMsg);
        ...
        println(CommandsEnteredHeading);
